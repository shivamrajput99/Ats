...
<div class="block-17 my-4">
              <form id="login-form" action="addtimingprocess.jsp" method="post" class="form-inline">
...
%>  
                  ...
                  <div class="form-group"> <label for="exampleInputEmail2">Route Number</label> 
                     <select name="route" id="route" class="form-control" placeholder="Keyword search" required>
                      <option value="">-Selete-</option>
...
while(rs3.next())
    {
           ...
           %>
            <option value="<% out.println(rs3.getInt("destination_id"));   %>"><% out.println(rs3.getString("destination_name"));   %></option>
            <%
            }
rs3.close();
statement3.close();
%>  
                                                 ...
                                                 <tr>
                                                      <td>
                                   <div class="form-group"> <label for="exampleInputEmail2">Bus Timing</label> 
                                   <br>
