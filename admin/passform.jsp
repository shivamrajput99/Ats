...
String sql="select * from passreg";
...
%>     
						...
						<% out.println(rs1.getString("pass_id"));%>
                                                    ...
                                                    <td>
						<% out.println(rs1.getString("s_name"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("s_fname"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("s_dob"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("s_gender"));%>
                                                    </td>
                                                      <td>
						<% out.println(rs1.getString("s_aadharno"));%>
                                                    </td>
                                                      <td>
						<% out.println(rs1.getString("s_mnumber"));%>
                                                    </td>
                                                      <td>
						<% out.println(rs1.getString("s_email"));%>
                                                    </td>
                                                      <td>
						<% out.println(rs1.getString("s_photo"));%>
                                                    </td>
                                                      <td>
						...
						<% out.println(rs1.getString("sc_pincode"));%>
                                                      ...
                                                      <td>
						<% out.println(rs1.getString("pass_type"));%>
                                                    </td>
                                                      <td>
						<% out.println(rs1.getString("pass_month"));%>
                                                    </td>
                                                </tr>
						  <% } %>
						</tbody>
