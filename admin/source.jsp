...
%>
                            ...
                            <form id="login-form" action="sourceprocess.jsp" method="post">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Enter Bus Stop</label>
                                    &nbsp; &nbsp;    <input type="text" name="source" id="source" class="form-control" placeholder="Source" onkeypress="return isAlfa(event)" required="required">
                                    </div>
...
<%
		...
		{
                   String s1=request.getParameter("sourceid"); 
                   String sql="Select * from source where source_id='"+s1+"' ";
...
<form id="login-form" action="sourceedit.jsp" method="post">
                                    <div class="row">
                                    <div class="form-group col-md-12">
                   <label>Edit Bus Stop</label>
                   <input type="hidden" name="sourceid" value="<% out.println(s1); %>"/>
          <input type="text" name="source" id="source" class="form-control" onkeypress="return isAlfa(event)" value="<% out.println(rs1.getString("source_name")); %>" required>
                </div> 
