...
%>     
						...
						<% out.println(rs1.getString("account_id"));%>
                                                    ...
                                                    <td>
						<% out.println(rs1.getString("account_name"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("account_lname"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("account_email"));%>
                                                    </td>
                                                    <td>
						<% out.println(rs1.getString("account_number"));%>
                                                    </td>
                                                </tr>
						  <% } %>
						</tbody>
