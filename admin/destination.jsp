...
%>
                            ...
                            <form id="login-form" action="destinationprocess.jsp" method="post">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Enter Bus Stop</label>
                                    &nbsp; &nbsp;    <input type="text" name="destination" id="destination" class="form-control" placeholder="Destination" onkeypress="return isAlfa(event)" required="required">
                                    </div>
                                  
                                   
                                    <div class="col-md-12 text-center login-btn">
                                        <div class="actions wow fadeInUp" data-wow-delay=".4s" style="visibility: visible;">
                                            <input type="submit" value="Submit" name="submit" id="btnSubmit" class="" title="Add Bus Stop!!!">
                                        </div>
                                    </div>
                                </div>
<%
		...
		{
                   String s1=request.getParameter("destinationid"); 
                   String sql="Select * from destination where destination_id='"+s1+"' ";
...
<form id="login-form" action="destinationedit.jsp" method="post">
                                    <div class="row">
                                    <div class="form-group col-md-12">
                   <label>Edit Bus Stop</label>
                   <input type="hidden" name="destinationid" value="<% out.println(s1); %>"/>
          <input type="text" name="destination" id="destination" class="form-control" onkeypress="return isAlfa(event)" value="<% out.println(rs1.getString("destination_name")); %>" required>
                </div> 
...
if(request.getParameter("st2")!=null)
   {
...
else if(request.getParameter("st1")!=null)
    {
     %>
    <script>
    alert("Bus Stop is already added!!!");
    </script>
