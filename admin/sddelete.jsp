...
%>   
						...
						<% out.println(rs1.getString("source_name"));%>
                                               ...
                                               <td>
                                            <a href="sourcedelete.jsp?sourceid=<% out.println(rs1.getString("source_id"));%>">
                                             <img src="images/del.jpg" alt="ed" width="50px" height="20px" >
                                            </a>  
                                           </td>
                                                </tr>
						  <% } %>
...
%>   
						...
						<% out.println(rs.getString("destination_name"));%>
                                               ...
                                               <td>
                                            <a href="destinationdelete.jsp?destinationid=<% out.println(rs.getString("destination_id"));%>">
                                           <img src="images/del.jpg" alt="ed" width="50px" height="20px" >
                                            </a>  
                                           </td>
                                                </tr>
